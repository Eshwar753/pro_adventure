...
createRoutesFromElements(
  <Route path='/' element= {<App />}>
    ...
    <Route path='/pages/:pageNumber' element= {<HomeScreens />} />
    <Route path='/search/:keyword/pages/:pageNumber' element= {<HomeScreens />} />
    ...
    <Route path='/admin/productlist/pages/:pageNumber' element= {<ProductListScreen/>} />
